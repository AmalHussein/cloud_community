...
ActiveRecord::Schema.define(version: 20140114150739) do
  ...
  create_table "instruments_users", force: true do |t|
    t.integer "user_id"
  ...
  create_table "users", force: true do |t|
    ...
    t.integer  "cc_birthday_day"
    t.integer  "cc_birthday_month"
  end
